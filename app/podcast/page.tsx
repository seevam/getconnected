      ...
      <section className="relative pt-28 pb-20 bg-gradient-to-b from-violet-900/20 to-[#09090b] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-12">
            <Link
              href="#episodes"
              className="px-5 py-2.5 rounded-xl bg-violet-400 text-[#09090b] text-sm font-semibold hover:bg-violet-300 transition-colors"
            >
              🎧 Start Listening
            </Link>
            <Link
              href="#subscribe"
              className="px-5 py-2.5 rounded-xl border border-zinc-700 text-zinc-300 text-sm font-semibold hover:bg-zinc-800 transition-colors"
            >
              📩 Subscribe Free
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="bg-zinc-900 border border-violet-800/30 rounded-2xl overflow-hidden hover:border-violet-600/40 transition-all">
                <div className="h-48 bg-gradient-to-br from-violet-900/60 to-zinc-900 flex items-center justify-center relative">
                  <span className="text-7xl">{latest.icon}</span>
                  ...
                  <button className="absolute inset-0 flex items-center justify-center">
                    <div className="w-16 h-16 rounded-full bg-violet-400/20 border-2 border-violet-400/50 flex items-center justify-center text-xl text-white hover:bg-violet-400/30 transition-colors backdrop-blur">
                      ▶
                    </div>
                  </button>
                </div>
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    <span className="text-xs text-zinc-500">🕒 {latest.duration}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    <button className="px-4 py-2 rounded-lg bg-violet-400 text-[#09090b] text-sm font-semibold hover:bg-violet-300 transition-colors">
                      ▶ Play Episode
                    </button>
          ...
          <aside className="space-y-6" id="subscribe">
            ...
            <div className="bg-gradient-to-br from-violet-900/50 to-zinc-900 border border-violet-800/30 rounded-2xl p-5">
              <h3 className="text-sm font-bold text-zinc-100 mb-2">🎧 Listen Everywhere</h3>
